...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://TELEFLIX_BOT:TELEFLIX_BOT@cluster0.yzds92r.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "TELEFLIX_BOT")
